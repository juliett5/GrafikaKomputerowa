...
public class SubroutineHierarchy extends JPanel {
    ...
    {
        Figure(g2,-3.35,2.35,0.003,0.003);
        Figure(g2,-1.6,1.75,0.003,0.003);
        Kwadrat(g2,-2.5,2.0,2,0.2, Color.RED);
        Trojkat(g2,-2.5,0.5,0.7,1.5 , Color.MAGENTA);

        Figure(g2,3.3,2.0,0.002,0.002);
        Figure(g2,1.7,2.4,0.002,0.002);
        Kwadrat(g2,2.5,2.2,1.8,0.2, Color.RED);
        Trojkat(g2,2.5,0.9,0.6,1.3 , Color.GREEN);

        Figure(g2,-0.95,0.05,0.004,0.004);
        Figure(g2,0.95,-0.50,0.004,0.004);
        Kwadrat(g2,0,-0.2,2.2,0.3, Color.RED);
        Trojkat(g2,0,-2.2,1,2 , Color.BLUE);
    ...
    private void Kwadrat(Graphics2D g2, double posX, double posY,double scaleX, double scaleY, Color color) {
    ...
    private void Trojkat(Graphics2D g2,double posX, double posY,double scaleX, double scaleY, Color color) {
        AffineTransform saveTransform = g2.getTransform();
        Color saveColor = g2.getColor();
        g2.setColor( color );
        g2.translate(posX,posY);
    ...
    private void Figure(Graphics2D g2, double posX, double posY,double scaleX, double scaleY) {
        AffineTransform Transform = g2.getTransform();
        Color saveColor = g2.getColor();
        g2.setColor(Color.BLACK);
        g2.translate(posX, posY);
        g2.rotate(Math.toRadians(frameNumber * 1));
        g2.scale(scaleX, scaleY);
        polygon(g2);
        g2.setColor(saveColor);
