...
public class Transforms2D extends JPanel {
    ...
    private class Display extends JPanel {
        protected void paintComponent(Graphics g) {
            ...
            AffineTransform old = g2.getTransform();//zapisuje obraz
            g2.setStroke(new BasicStroke(5));//grubość obramowania
            int n = 19;
            ...
            if (whichTransform == 1)
            {
                ...
                g2.setTransform(old);//resetuje do pierwotnej postaci
            }
