...
void Spirala()
{
    ...
    {   
        ...
        glPointSize(RozmiarA);
        RozmiarA = RozmiarA + RozmiarB; //rozszerzanie sprê¿yny 
        glBegin(GL_POINTS);
        {
            x = 1.0f * sinf(k);
            y = 1.0f * cosf(k);
