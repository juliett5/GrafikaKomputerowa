...
public class SceneGraph extends JPanel {
     ...
     */
    private TransformedObject trojkat1,trojkat2,trojkat3;
    private TransformedObject prostokat1,prostokat2,prostokat3;
    private TransformedObject figura11,figura12,figura21,figura22,figura31,figura32;
    ...
    private void createWorld() {
        ...
        figura11 = new TransformedObject(Figure);
        figura12 = new TransformedObject(Figure);
        trojkat1 = new TransformedObject(filledTriangle);
        prostokat1 = new TransformedObject(filledRect);

        trojkat2 = new TransformedObject(filledTriangle);
        prostokat2 = new TransformedObject(filledRect);
        figura21 = new TransformedObject(Figure);
        figura22 = new TransformedObject(Figure);

        trojkat3 = new TransformedObject(filledTriangle);
        prostokat3 = new TransformedObject(filledRect);
        figura31 = new TransformedObject(Figure);
        figura32 = new TransformedObject(Figure);
        

        figura11
                .setTranslation(-3.35,2.45)
                .setScale(0.003,0.003)
                .setColor(Color.BLACK);
        figura12
                .setTranslation(-1.6,1.95)
                .setScale(0.003,0.003)
                .setColor(Color.BLACK);
        prostokat1
                .setTranslation(-2.5,2.2)
                .setScale(2,0.2)
                .setRotation(-15)
                .setColor(Color.RED);
        trojkat1.setTranslation(-2.5,0.5)
                .setScale(0.7,1.5)
                .setColor(new Color(128,0,128));

        world.add(figura11);
        world.add(figura12);
        world.add(prostokat1);
        world.add(trojkat1);


        figura21
                .setTranslation(-0.95,0.05)
                .setScale(0.004,0.004)
                .setColor(Color.BLACK);
        figura22
                .setTranslation(0.95,-0.50)
                .setScale(0.004,0.004)
                .setColor(Color.BLACK);
        prostokat2.setTranslation(0,-0.2)
                .setScale(2.2,0.3)
                .setRotation(-15)
                .setColor(Color.RED);
        trojkat2.setTranslation(0,-2.0)
                .setScale(1,2)
                .setColor(new Color(0,0,255));
        world.add(figura21);
        world.add(figura22);
        world.add(prostokat2);
        world.add(trojkat2);



        figura31
                .setTranslation(3.3,2.2)
                .setScale(0.002,0.002)
                .setColor(Color.BLACK);
        figura32
                .setTranslation(1.7,2.6)
                .setScale(0.002,0.002)
                .setColor(Color.BLACK);
        prostokat3.setTranslation(2.5,2.4)
                .setScale(1.8,0.2)
                .setRotation(-15)
                .setColor(Color.RED);
        trojkat3.setTranslation(2.5,0.9)
                .setScale(0.6,1.3)
                .setColor(new Color(34,139,34));
        world.add(figura31);
        world.add(figura32);
        world.add(prostokat3);
        world.add(trojkat3);
    ...
    public void updateFrame()
    {
        ...
        figura11.setRotation(frameNumber*1);
        figura12.setRotation(frameNumber*1);
        figura21.setRotation(frameNumber*1);
        figura22.setRotation(frameNumber*1);
        figura31.setRotation(frameNumber*1);
        figura32.setRotation(frameNumber*1);
    ...
    private static SceneGraphNode Figure = new SceneGraphNode()
    {
        void doDraw(Graphics2D g) {
            int n = 19;
